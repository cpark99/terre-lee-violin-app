...
export default function Lessons(props) {
  ...
  return (
    <section id="lessons" className="container flex-responsive-landscape">
      <ScrollToTopOnMount />
      ...
      <div id="lessons-information" className="responsive-column-landscape">
        ...
        <p>
          Depending on the child's age and ability, lessons start at 30 minutes, then build to 1
          hour.
        </p>
        <p>
          It is required there is a consistent parent or adult who is part of the child’s lessons
          and practice at home. This parent or adult is expected to take notes with guidance of the
        ...
        <p>
          ...
          classes, students will review music vocabulary, refine techniques, work and play together
          as an ensemble, develop leadership skills, and have a good time!
        </p>
        <p>
